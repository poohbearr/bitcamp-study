...
public class Exam1 {
  ...
  // 테스트 URL : http://localhost:8080/lang/variable/exam1/test1?tel=010-1111-2222&gender=woman&name=%ED%99%8D%EA%B8%B8%EB%8F%99
  @GetMapping("/test1")
  ...
  // 테스트 URL : http://localhost:8080/lang/variable/exam1/test2?b=100&s=-32768&i=2100000000&l=9220000000000000000
  @GetMapping("/test2")
